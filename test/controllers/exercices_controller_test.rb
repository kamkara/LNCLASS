...
class ExercicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercice" do
    assert_difference('Exercice.count') do
      post exercices_url, params: { exercice: { author: @exercice.author, content: @exercice.content, course_id: @exercice.course_id, search_id: @exercice.search_id, slug: @exercice.slug, title: @exercice.title, user_id: @exercice.user_id } }
    end
  ...
  test "should update exercice" do
    patch exercice_url(@exercice), params: { exercice: { author: @exercice.author, content: @exercice.content, course_id: @exercice.course_id, search_id: @exercice.search_id, slug: @exercice.slug, title: @exercice.title, user_id: @exercice.user_id } }
